...
public class DependencyInjectionTests(MockedApplicationFactory<Other.Program> factory, ITestOutputHelper output)
    : IClassFixture<MockedApplicationFactory<Other.Program>>
{
    [Fact]
